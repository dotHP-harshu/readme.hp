...
function ReadmeSection({ readmeMarkdown }: PropsInterface) {
  ...
  return (
    <section className="w-full readme-section px-6 py-6 ">
      {/* ----------------------- header start --------------------------------- */}
      ...
      <div className="flex items-center gap-2 max-w-5xl w-full mx-auto">
        <span><AlertTriangle className="text-amber-500/50" /></span>
        <p className="text-amber-500/50 leading-none text-sm">Generated by AI; verify important details.</p>
      </div>

      {/* --------------------------- buttons end ------------------------ */}
      <div className="border-2 border-border-light dark:border-border-dark rounded-2xl overflow-hidden max-w-5xl w-full mx-auto">
        ...
        {/* --------------------------- buttons end ------------------------ */}
        <div className="overflow-y-auto scroller h-[80dvh] max-h-[90dvh] p-2 w-full ">
          {isShowingPreview ? (
