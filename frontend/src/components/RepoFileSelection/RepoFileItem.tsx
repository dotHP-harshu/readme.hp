...
const RepoFileItem  = React.memo(({file,isChecked,toggleFile,pathColors}:RepoFileItemProps) =>{
    return (
         <li
                  ...
                  >
                    ...
                    />
                      <p className="w-full truncate cursor-pointer peer self-center" title={file.path}>
